...
type GreetRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // 挨拶する相手の名前
...
type GreetResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Greeting      string                 `protobuf:"bytes,1,opt,name=greeting,proto3" json:"greeting,omitempty"` // 生成された挨拶文
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_greet_v1_greet_proto_rawDesc = "" +
	...
	"\fGreetService\x12:\n" +
	"\x05Greet\x12\x16.greet.v1.GreetRequest\x1a\x17.greet.v1.GreetResponse\"\x00BAZ?github.com/aiirononeko/kintore-app/backend/gen/greet/v1;greetv1b\x06proto3"
